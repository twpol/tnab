...
void PrintMarkupNode(int level, MarkupNode node)
{
    switch (node)
    {
        case MarkupDocument document:
            ...
            if (document.DocType != null) Console.WriteLine("{0}<!{1}>", GetMarkupIndent(level + 1), document.DocType);
